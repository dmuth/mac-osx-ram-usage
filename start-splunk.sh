...
echo "# "
echo "# The above settings correspond to environment variables. "
echo "# You can adjust them in the command line like this: "
echo "# "
echo "# SPLUNK_PORT=8080 $0"
echo "# "
echo "# "
echo "# Your Splunk instance will be available at: https://localhost:${SPLUNK_PORT}/"
echo "# "
echo "> "
